...
This file tracks upcoming features, bugs, and tech debt.

Guidelines:
- Keep items short and action-oriented.
- Use checkboxes and add an owner or initials when possible.
- Move completed items to the changelog if they shipped.
