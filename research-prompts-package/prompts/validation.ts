...
export const section1OutputSchema = z.object({
  confidence: confidenceSchema,
...
export const section2OutputSchema = z.object({
  confidence: confidenceSchema,
...
export const strategicPrioritySchema = z.object({
  ...
  description: z.string(),
  geography_relevance: z.string(),
  geography_relevance_rating: z.enum(['High', 'Medium', 'Low']),
  source: z.string()
});
...
export const section3OutputSchema = z.object({
  confidence: confidenceSchema,
...
export const section4OutputSchema = z.object({
  confidence: confidenceSchema,
  overview: z.string().min(100),
...
export const section5OutputSchema = z.object({
  confidence: confidenceSchema,
...
export const section6OutputSchema = z.object({
  confidence: confidenceSchema,
...
export const section7OutputSchema = z.object({
  confidence: confidenceSchema,
...
export const section8OutputSchema = z.object({
  confidence: confidenceSchema,
...
export const section9OutputSchema = z.object({
  confidence: confidenceSchema,
...
export const section10OutputSchema = z.object({
  confidence: confidenceSchema,
...
export function validateCompleteResearch(output: unknown): boolean {
  ...
  try {
    ...
    if (research.section1) section1OutputSchema.parse(research.section1);
    if (research.section2) section2OutputSchema.parse(research.section2);
    if (research.section3) section3OutputSchema.parse(research.section3);
    if (research.section4) section4OutputSchema.parse(research.section4);
    if (research.section5) section5OutputSchema.parse(research.section5);
    if (research.section6) section6OutputSchema.parse(research.section6);
    if (research.section7) section7OutputSchema.parse(research.section7);
    if (research.section8) section8OutputSchema.parse(research.section8);
    if (research.section9) section9OutputSchema.parse(research.section9);
    if (research.section10) section10OutputSchema.parse(research.section10);
