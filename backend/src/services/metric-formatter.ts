/**
 * Shared metric formatting module.
 * Provides consistent formatting for currency, percentage, ratio, and other
 * metric types across markdown, DOCX, and frontend rendering pipelines.
 *
 * Keep in sync with: frontend/src/utils/metric-formatter.ts
 */
